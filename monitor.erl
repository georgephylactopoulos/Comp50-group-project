...
%%The idea is that it first deals with any tablets that have died and then 
%%gets a new list of tablets from the master.
loop(Monitored_Tablets,Refresh_rate,MasterPid) ->
	receive
		{'DOWN',Reference,process,Process,_Reason} -> 
			gen_server:cast(MasterPid, {is_down, Process}),
